...
<div class="wrap">
	...
	<textarea id="upload-scan-view-log" name="upload_scan_view_log" style="font-family: monospace; width: 90%; height: 500px; margin: 25px auto auto 25px;"><?php
		if ( $this->does_log_file_exist() ) {
			$fp = fopen( get_option( 'upload-scan_onfail_log_file' ) , 'r' );
