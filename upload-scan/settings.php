...
<div class="wrap">
	...
	<h2>Upload Scan Options</h2>

	<form id="upload-scan-settings-form" name="upload-scan-settings-form" method="post" action="<?php echo add_query_arg( '__action', 'save' ); ?>">
		
		<?php wp_nonce_field( 'upload-scan-save-settings' ); ?>
		...
		<p>
		Use this command:<br />
		<textarea id="upload-scan_command" style="width: 80%; height: 75px; font-family: monospace;" name="upload_scan_command"><?php echo htmlentities( get_option( 'upload-scan_command' ) ); ?></textarea>
		</p>
		...
		<p>
		<label>
			<input type="checkbox" id="upload-scan_onfail_quarantine_file" name="upload_scan_onfail_quarantine_file" <?php checked( get_option( 'upload-scan_onfail_quarantine_file' ) ); ?> />
		...
		<p>
			...
			<input type="text" id="upload-scan_quarantine_folder" name="upload_scan_quarantine_folder" value="<?php echo htmlentities( get_option( 'upload-scan_quarantine_folder' ) ); ?>" />
			<br />
